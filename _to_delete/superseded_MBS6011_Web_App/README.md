...
A proctored online test platform for MBS6011 E-Business Strategies and Models,
...
This is the web successor to the CSC6711/MBS6011 Windows executable. The proctoring
rules, the warn-then-flag policy and the PDF layout are carried over; the delivery,
storage and administration are new.
...
3. Add questions, or paste a `quiz_data.json` from the desktop app into **Bulk import**.
...
The same files the desktop app used will do. Copy one to
